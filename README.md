...
- `prompt-api-observability`: PoC for tracing the Prompt API in the browser with the OpenTelemetry GenAI semantic conventions, exported over OTLP/HTTP to MLflow or an OpenTelemetry Collector.
